...
<body class="hold-transition theme-primary bg-img" style="background-image: url(../images/auth-bg/bg-8.jpg)">
						...
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="p-40">
								<form method="POST" action="{{ route('register') }}">
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control ps-15 bg-transparent" value="{{ old('name') }}" name="name" placeholder="Name">
										</div>
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="email" class="form-control ps-15 bg-transparent" value="{{ old('email') }}" name="email" placeholder="Email">
										</div>
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Already have an account?<a href="{{ route('login.form') }}" class="text-danger ms-5"> Sign In</a></p>
								</div>
							</div>
						</div>								
